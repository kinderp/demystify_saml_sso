...
------------ | ------------- | -------------
`/` | views.IndexView | It's sp login page. If an user is not logged in idp portal it shows a link that will redirect to idp login page `/login/?next=/idp/login/process/` otherwise it shows user's page into sp portal.
