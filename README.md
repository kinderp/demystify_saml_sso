...
`saml2/login/` | Content in the second column | ...
`saml2/acs/` | Content in the second column | ...
`saml2/logout/` | Content in the second column | ...
`saml2/ls/` | Content in the second column | ...
`saml2/lspost/` | Content in the second column | ...
